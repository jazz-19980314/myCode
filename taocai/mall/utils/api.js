...
module.exports = {
  ...
  orderPay:(data)=>{ //订单账期
	  return request('/mall/api/ma/historicalSettlement/page', 'get', data, false)
  },
  putorderPay:(data)=>{ //订单账期确认
  	  return request('/mall/api/ma/historicalSettlement', 'put', data, false)
  },
  ...
  pubilcty:(data) =>{ //产品宣传视频
	  return request('/mall/api/ma/homepage/page','get',data,true)
  },
  createContarct:(data) =>{
	  return request(`/mall/api/ma/orderinfo/generateContract?orderNo=${data}`,'get',data,true)
  },
  addUsre:(data) =>{ //开商城
	  return request('/mall/supplyapply','post',data,true)
  }
}