...
<template>
  <div v-if="type == 'image'">
      ...
      <li tabindex="0" class="el-upload-list__item is-ready" :style="'width: ' + width + 'px;height: ' + height + 'px'">
        <div>
          ...
          <span class="el-upload-list__item-actions">
            <span class="el-upload-list__item-preview" v-if="index != 0" @click="moveMaterial(index, 'up')"><i class="el-icon-back"></i></span>
            <span class="el-upload-list__item-preview" @click="zoomMaterial(index)"><i class="el-icon-view"></i></span>
            <span class="el-upload-list__item-delete" @click="deleteMaterial(index)"><i class="el-icon-delete"></i></span>
            <span class="el-upload-list__item-preview" v-if="index != value.length - 1" @click="moveMaterial(index, 'down')"><i class="el-icon-right"></i></span>
          </span>
        </div>
      </li>
    </ul>
    ...
    <el-dialog append-to-body :visible.sync="dialogVisible" width="35%"><img :src="url" alt="" style="width: 100%" /></el-dialog>

    <el-dialog title="素材库" append-to-body :visible.sync="listDialogVisible" width="70%">
      <el-container>
        <el-aside width="unset">
          <div style="margin-bottom: 10px"><el-button class="el-icon-plus" size="small" @click="materialgroupAdd()">添加分组</el-button></div>
                  ...
                  <el-col :span="4" v-for="(item, index) in tableData" :key="index">
                    <el-card :body-style="{ padding: '5px' }">
                      ...
                      <div>
                        ...
                        <el-row>
                          <el-col :span="6" class="col-do"><el-button type="text" class="button-do" @click="materialRename(item)">改名</el-button></el-col>
                          <el-col :span="6" class="col-do"><el-button type="text" class="button-do" @click="materialUrl(item)">链接</el-button></el-col>
                          <el-col :span="6" class="col-do">
                            <el-dropdown trigger="click" @command="handleCommand">
                              ...
                              <el-dropdown-menu slot="dropdown">
                                <el-dropdown-item
                                  v-for="(item2, index) in materialgroupList"
                                  v-if="index > 0"
                                  :key="index"
                          ...
                          <el-col :span="6" class="col-do"><el-button type="text" class="button-do" style="color: red" @click="materialDel(item)">删除</el-button></el-col>
                        </el-row>
                      </div>
                    </el-card>
                  </el-col>
